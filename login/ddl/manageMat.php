	...
	<div class="page">
      ...
      <div class="ul">
          <ul class="nav nav-tabs">
            ...
            <li class=""><a class="NotSelect" id="LinkActionOff" href="">人员信息管理</a></li>
            <li class=""><a class="NotSelect" id="LinkActionOff" href="text.html">床位信息管理</a></li>
            <li class="active"><a class="IsSelect" id="LinkActionOn" href="message.html">信息汇总平台</a></li>
          </ul>
        </div>
        ...
        <a href="" title="" id="personal">个人中心</a>
          ...
          if (isset($_POST['AddInfo'])) {
            ...
            if (!empty($mat_id) && !empty($name) && !empty($sex) && !empty($age) && !empty($condition) && !empty($phone)) {
              ...
              if (mysqli_num_rows($data) == 0) {
                //The mat_id is unique, so insert the data into the database
                $query = "INSERT INTO maternal (mat_id, name, sex, age, condition, phone) VALUES ('$mat_id', '$name', '$sex', '$age', '$condition', '$phone' )";
                // echo '$query';
                // exit();
                mysqli_query($dbc, $query);
                mysqli_close($dbc);
