<?php 
	...
	$dbc = mysqli_connect($host,$username,$password,$databaseName);
 	...
 	$age1 = "select * from maternal where age>=15 and age<25";
 	$age2 = "select * from maternal where age>=25 and age<35";
 	$age3 = "select * from maternal where age>=35 and age<45";
 	$age4 = "select * from maternal where age>=45";
    ...
    //}
 	$json = array('m_age1'=>$num1,'m_age2'=>$num2,'m_age3'=>$num3,'m_age4'=>$num4);
